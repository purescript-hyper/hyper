...
The primary use of routing types in Hyper is for writing web servers. The
`purescript-hyper-routing-server <https://github.com/owickstrom/purescript-hyper-routing-server>`__
